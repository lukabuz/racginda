...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-121429645-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-121429645-1');
  </script>
  <meta charset="UTF-8">
...
<body>
  ...
  <main class="grid">
    ...
    <div class="form">
    <form action='../submission/{{$submission->id}}' method='POST' id="form1" enctype="multipart/form-data">
      <h1>უპასუხე.</h1>
      @csrf
    ...
    <div class="item">
      <div class="content">
        <p>{!! nl2br(e(preg_replace('>.*/g', '<font color="#789922">$1</font>', preg_replace('!(((f|ht)tp(s)?://)[-a-zA-Zа-яА-Я()0-9@:%_+.~#?&;//=]+)!i', '<a href="$1" target="_blank">$1</a>', $submission->description)))) !!}</p>
      ...
      <div class="item-reply">
        <div class="content">
          ...
          @if($reply->imageLink != null)
            <a href="https://s3.eu-central-1.amazonaws.com/racginda/photos/{{$reply->imageLink}}" target="_blank">
